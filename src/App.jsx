...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0f] via-[#181824] to-[#101014] text-gray-100 font-sans flex flex-col items-center">
      ...
      {/* Services Section */}
      <section id="services" className="w-full max-w-5xl mx-auto py-10 sm:py-14 md:py-16 px-2 sm:px-4">
        <h2 className="text-center text-xl sm:text-2xl font-bold text-yellow-400 mb-8 md:mb-10">Services</h2>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="w-full max-w-6xl mx-auto py-10 sm:py-14 md:py-16 px-2 sm:px-4">
        <h2 className="text-center text-xl sm:text-2xl font-bold text-yellow-400 mb-8 md:mb-10">Portfolio</h2>
      ...
      <section id="contact" className="w-full max-w-3xl mx-auto py-10 sm:py-14 md:py-16 px-2 sm:px-4">
        <h2 className="text-center text-xl sm:text-2xl font-bold text-yellow-400 mb-8 md:mb-10">Contact</h2>
        <form className="bg-[#232336] rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 flex flex-col gap-4 sm:gap-6 border border-[#232336]">
          <input type="text" placeholder="Your Name" className="bg-[#181824] border border-gray-700 rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-gray-100 placeholder-gray-500 focus:outline-none focus:border-yellow-400 transition" />
          <input type="email" placeholder="Your Email" className="bg-[#181824] border border-gray-700 rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-gray-100 placeholder-gray-500 focus:outline-none focus:border-yellow-400 transition" />
          <textarea placeholder="Your Message" rows={5} className="bg-[#181824] border border-gray-700 rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-gray-100 placeholder-gray-500 focus:outline-none focus:border-yellow-400 transition" />
          <button type="submit" className="px-4 py-2 sm:px-6 sm:py-3 rounded-full bg-yellow-400 text-[#181824] font-semibold shadow hover:bg-yellow-300 transition">Send Message</button>
        </form>
      </section>

      {/* Footer */}
      <footer className="w-full bg-[#181824] border-t border-[#232336] py-6 sm:py-8 mt-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 px-2 sm:px-4">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <span className="font-bold text-lg text-white">ETSU</span>
            <ul className="flex flex-wrap gap-4 sm:gap-6 mt-2 text-gray-400 text-sm">
